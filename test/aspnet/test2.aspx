         ...
         // Opens the registry key for the .NET Framework entry.
            ...
            foreach (string versionKeyName in ndpKey.GetSubKeyNames())
            {
                if (versionKeyName.StartsWith("v"))
                {
                    ...
                    {
                        Response.Write(versionKeyName + "  " + name);
                        Response.Write("<br/>");
                    }   
                    else
                    {
                        if (sp != "" && install == "1")
                        {
                            Response.Write(versionKeyName + "  " + name + "  SP" + sp);
                            Response.Write("<br/>");
                        }
                    ...
                    foreach (string subKeyName in versionKey.GetSubKeyNames())
                    {
                        ...
                        else
                        {
                            if (sp != "" && install == "1")
                            {
                                Response.Write("  " + subKeyName + "  " + name + "  SP" + sp);
                                Response.Write("<br/>");
                            }
                            else if (install == "1")
                            {
                                Response.Write("  " + subKeyName + "  " + name);
                                Response.Write("<br/>");
                            }
                        }
                    }
...
<div class="page">
  ...
  <div><%  GetVersionFromRegistry(); %></div>
  </form>
  <div class="footer">
