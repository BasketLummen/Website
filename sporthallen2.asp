...
<SCRIPT type="text/javascript" src="inc/jquery.jsonSuggest.js"></SCRIPT>
...
{	
	$.getJSON("json/gemeenten.php", function(data){
		$("input#txtgemeente").jsonSuggest(data);

		 /*  $("#gemeenten").html('<option value="0">Kies een gemeente</option>');
			$.each(data,function(){
				$('<option></option>').val(this.gemeente).text(this.gemeente).appendTo("#gemeenten");
			});*/
	});
}
...
<select id='gemeenten' style='width:220px;'></select>
...
<table width="450" border="0" align="center" cellspacing="0" cellpadding="3" style="border-top: 2px solid #DDDDDD; border-right: 2px solid #DDDDDD; border-bottom: 2px solid #DDDDDD; border-left: 2px solid #DDDDDD;">
	<tr bgcolor="#DDDDDD"> 
	  <td nowrap class="NieuwsTitels" colspan="2"><img src="img/driehoek_rood.gif" width="5" height="9" border="0"> Geef de gemeente of de club de je zoekt</td>
	</tr>
    <tr>
      <td width="86">Gemeente</td>
      <td width="192"><input type="text" name="gemeente" id="txtgemeente" tabindex="1"></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    ...
    <tr>
      <td>Club </td>
      <td><input type="text" name="club" tabindex="2"></td>
    </tr>
	<tr>
	  <td colspan="2" align="center"><input type="submit" value="zoek" tabindex="3"></td>
	</tr>
  </table>
</form>
</div>
