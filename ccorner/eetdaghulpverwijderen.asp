...
sqlstring = "DELETE FROM tbleetdagtaakverdeling WHERE taaknr="&id&" AND shift="&tijd&" AND naam = '"&naam&"'"
con.execute sqlstring

sqlstring = "SELECT naam FROM tbleetdagtaakverdeling WHERE taaknr = " & id & " AND shift = " & tijd
rs.open sqlstring
tel = 0
while not rs.eof
	tel = tel + 1
...
sqlstring = "SELECT * FROM  tbleetdagtaken WHERE id = " & id
