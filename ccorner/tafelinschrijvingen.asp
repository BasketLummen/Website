...
<title>Basket Lummen - Tafelverantwoordelijke</title>
...
<h3>Inschrijvingen tafelverantwoordelijke</h3>
<table>
<tr>
...
<%sqlstring = "SELECT * FROM tblcarwash where id > 1"
rs.open sqlstring
while not rs.eof%>
    <tr bgcolor="#FFFFFF">
        <td valign="top"><%=(rs("id")-1)%></td>
