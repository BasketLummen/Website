...
<p class="NieuwsTitels"><font size="3">Ex-leden</font></p>
</td>
<td width="50%" align="right">
<%if session("BL_soort") < 3 then%>
<a href="vroegereledenexcel.asp?functie=<%=functie%>&ord=<%=ord%>"><img src="../img/msexcel.gif" border="0" alt="Download deze lijst in excel" /></a>
<%end if%>
</td>
</tr>
</table>
...
<table>
	<tr>
		<th nowrap><a href="vroegereleden.asp?ord=1">id</a></th>
		<th nowrap><a href="vroegereleden.asp?ord=2">vblnr</a></th>
		<th nowrap><a href="vroegereleden.asp?ord=0">naam</a></th>
		<th nowrap>voornaam</th>
		<th nowrap>adres</th>
		<th nowrap><a href="vroegereleden.asp?ord=3">geboortedatum</a></th>
		<th nowrap><a href="vroegereleden.asp?ord=4">geslacht</a></th>
		<th nowrap><a href="vroegereleden.asp?ord=5">aansluitingsdatum</a></th>
		<th nowrap><a href="vroegereleden.asp?ord=6">status</a></th>
		<th nowrap>tel/gsm</th>
		<th nowrap>e-mail</th>
		<th nowrap>ouders gsm</th>
		<th nowrap>ouders e-mail</th>
		<th nowrap><a href="vroegereleden.asp?ord=7">vorige ploeg</a></th>
		<th nowrap><a href="vroegereleden.asp?ord=8">ploeg(en)</a></th>
		<th nowrap><a href="vroegereleden.asp?ord=9">niveau</a></th>
		<th nowrap><a href="vroegereleden.asp?ord=10">functie(s)</a></th>
		<th nowrap><a href="vroegereleden.asp?ord=0">naam</a></th>
		<th nowrap>voornaam</th>
	</tr>
<%while not rs.eof
